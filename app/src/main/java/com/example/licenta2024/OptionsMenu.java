...
//
//                    if (numAttractions > 7) {
//                        Toast.makeText(OptionsMenu.this, "Number of Attractions cannot be more than 10", Toast.LENGTH_SHORT).show();
...
//                    } else {
//                        // Proceed with the logic when all inputs are valid
//                        // You can use numAttractions, maxDistance, and selectedAttractionTypes here
//                    }
//                }
//            }
//        });
...
public class OptionsMenu extends AppCompatActivity {
            ...
            public void onClick(View view) {
                ...
                if (numAttractionsStr.isEmpty() || maxDistanceStr.isEmpty()) {
                    ...
                    if (numAttractions > 7) {
                        ...
                        // Proceed with fetching attractions and filtering
    ...
    private void filterAttractionsByDistance(ArrayList<DataAttractionAvailability> attractions, double maxDistance) {
        ...
        for (DataAttractionAvailability attraction : filteredAttractions) {
            Log.d("Filtered Attraction", attraction.getName());
        }

//        if (filteredAttractions.size() > nr) {
//            Collections.shuffle(filteredAttractions);
//            filteredAttractions = new ArrayList<>(filteredAttractions.subList(0, nr));
//        }
